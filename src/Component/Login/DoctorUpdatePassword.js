...
const DoctorUpdatePassword = () =>{
    ...
    const handleSubmit = async (event) => {
        ...
        try{
            const response = await axios.put('http://localhost:8080/api/v1/doctorUpdatePassword', {doctorWorkEmail, newPassword, confirmPassword});
    ...
    return (
        ...
        <form className="form-inline" onSubmit={handleSubmit}>
            ...
            <div class="form-group row mb-2">
                <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Email"  value={doctorWorkEmail} onChange={e => setDoctorWorkEmail(e.target.value)}/>
            </div>
