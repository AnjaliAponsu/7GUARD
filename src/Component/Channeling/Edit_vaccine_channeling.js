...
export default function Edit_vaccine_channeling() {
  ...
  console.log("channelid", channelingID)
  ...
  const handleSubmit = async (event) => {
    ...
    const channelingData = {
      ...
      channeling_bill: parseFloat(totalAmount),
  ...
  return (
    <div className='form20'>
      <div className="container d-flex align-items-center justify-content-center" style={{ minHeight: '100vh' }}>
        <div className="col-sm-8 py-2 px-5 shadow form21" id='Body3'>
          <h1 className="ha4">Update Channeling</h1>
          <form onSubmit={handleSubmit} >
            <div className='fo1'>
              ...
              <button className="btn vbtn" type="submit" disabled={!selectedDate || !channelingType}>
                Submit
              </button>
            </div>
          </form>
