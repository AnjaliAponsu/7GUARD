    ...
    <div className='col-sm-8 py-2 px-5 offset-2 shadow'  id='Body4'>
      ...
      {channelings ? (
        ...
        <div className='form-group row mb-2'>
          <label   htmlFor='impofid' className='col-sm-2 col-form-label'> Your Channeling Reference</label>
          <div className='col-sm-10'>
          <input className='form-control'  name="message7" value={ channelings.cha_id|| ''} readOnly />
          </div>
          </div>
        <div className='form-group row mb-2'>
          <label   htmlFor='impofid' className='col-sm-2 col-form-label'> Your Channeling Token</label>
          <div className='col-sm-10'>
          <input className='form-control'  name="message5" value={ channelings.channel_number|| ''} readOnly />
          </div>
          </div>
          <div className='form-group row mb-2'>
          <label   htmlFor='impofid' className='col-sm-2 col-form-label'> Your Channeling Time</label>
          <div className='col-sm-10'>
          ...
          <div className='form-group row mb-2'>
          <label   htmlFor='impofid' className='col-sm-2 col-form-label'> Parent Name</label>
          <div className='col-sm-10'>
          ...
          <div className='form-group row mb-2'>
          <label   htmlFor='impofid' className='col-sm-2 col-form-label'>Channeling Purpose/Vaccine Name</label>
          <div className='col-sm-10'>
          <input className='form-control'  name="message2" value={channelings.channeling_vaccine_name|| ''} readOnly />
            ...
            <div className='form-group row mb-2'>
          <label   htmlFor='impofid' className='col-sm-2 col-form-label'>Channeling Amount</label>
          <div className='col-sm-10'>
          ...
          <div className='form-group row mb-2'>
          <label   htmlFor='impofid' className='col-sm-2 col-form-label'>Today</label>
          <div className='col-sm-10'>
