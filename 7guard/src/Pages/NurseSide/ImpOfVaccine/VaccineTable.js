...
const ImpOfVaccineTable = () => {
    ...
    const handleDelete =async (impofid) => {
        const confirm = window.confirm("Do you want to delete "+impofid+" vaccine id related vaccine details?")
        if(confirm){
  ...
  return (
    ...
    <NurseNavBar/>
    <section>
        <h1>Importance of Vaccine</h1>
        <Link to={"/aiov"} className="btn vbtn mb-2">Add Vaccine</Link>
