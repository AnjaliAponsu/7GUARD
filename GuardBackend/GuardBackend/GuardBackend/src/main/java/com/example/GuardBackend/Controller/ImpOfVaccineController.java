...
public class ImpOfVaccineController {
    ...
    //CHDR view
    @GetMapping("/chdr/{CHDR_id}")
    public ResponseEntity<List<ImpOfVaccineDTO>> getVaccinesByCHDRId(@PathVariable Long CHDR_id) {
        List<ImpOfVaccineDTO> vaccines = vaccineService.getCHDRVaccineDetailsById(CHDR_id);
